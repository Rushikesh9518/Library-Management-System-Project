  ...
  return (
    <div className="p-6 bg-gray-100 min-h-screen">
      ...
      <button
        ...
        className="fixed bottom-6 left-1/2 transform -translate-x-1/2 bg-teal-500 text-white px-6 py-3 rounded-lg text-lg hover:bg-teal-600 transition duration-300 ease-in-out"
      >
        Back
      </button>
